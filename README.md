...
| Week       | Work Completed                                    |
| ---------- | ------------------------------------------------- |
| **Week 1-2** | Dataset preparation & preprocessiong             |
| **Week 3** | Fine-tune BioBERT for entity extraction        |
| **Week 4-5** | Fine-tune summarization model (T5/BART) with entity constraints  |
| **Week 6** | Implement hallucination mitigation & entity verification                    |
| **Week 7** | Post-processing, entity highlighting, and automatic evaluation         |
| **Week 8** | Human evaluation, analysis, report preparation, presentation          |
